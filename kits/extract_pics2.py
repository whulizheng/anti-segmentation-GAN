...
extract_source_1 = "C:/Users/WhuLi/Documents/HRSC2016/FullDataSet/Segmentations/"
extract_source_2 = "C:/Users/WhuLi/Documents/HRSC2016/FullDataSet/AllImages_png/"

extract_target_path = "C:/Users/WhuLi/Documents/HRSC2016/FullDataSet/antiseg/"
...
def resize_merge(imga, imgb, imgc, shape):

    joint = Image.new('RGB', (shape[0]+shape[0]+shape[0], shape[1]))
    loc1, loc2, loc3 = (0, 0), (shape[0], 0), (shape[0]+shape[0], 0)
    joint.paste(imga, loc1)
    joint.paste(imgb, loc2)
    joint.paste(imgc, loc3)
    return joint
    ...
    for f in tqdm(files_A):
        try:
            ...
            imgb = Image.open(extract_source_2 +
                              f).resize(shape, Image.ANTIALIAS)
            img = resize_merge(imgb, imga, imgc, shape)
